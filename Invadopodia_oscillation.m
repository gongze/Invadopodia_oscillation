...
% Written in 2019, final revison at Dec 2020.
...
for i=1:iternum
    tspan = [tstart tfinal];
    [t, y, te, ie, ye] = ode45(@(t,y) Fun_plasticity_invadopodia(t,y,spara), tspan, y0, options1);
    ...
    [t, y, te2, ie2, ye2] = ode45(@(t,y) Fun_invadopodia(t,y,spara, Ry), tspan, y0, options2);
    % Accumulate output.  This could be passed out as output arguments.
    nt = length(t);
    tout = [tout; t(2:nt)];
    yout = [yout; y(2:nt,:)];
